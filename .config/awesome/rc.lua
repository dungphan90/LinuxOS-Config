...
local myawesomemenu = {
    ...
    { "edit config", terminal.." vim /home/dphan/.config/awesome/rc.lua" },
    { "arandr", "arandr" },
...
globalkeys = my_table.join(
    ...
    function ()
        awful.spawn(string.format("dmenu_run -c -bw 2 -l 20 -g 4 -p 'Run:'",
        beautiful.bg_normal, beautiful.fg_normal, beautiful.bg_focus, beautiful.fg_focus))
	end,
    {description = "show my custom dmenu", group = "hotkeys"}),
    ...
    -- screenshots
    awful.key({ }, "Print", function () awful.util.spawn("scrot 'HPArch-%Y-%m-%d-%s_screenshot_$wx$h.jpg' -e 'mv $f /home/dphan/Screenshots'") end,
...
clientkeys = my_table.join(
    ...
    awful.key({ modkey, "Shift"   }, "c",      function (c) c:kill()                         end,
              {description = "close focus window", group = "hotkeys"}),
...
awful.spawn.with_shell("xbindkeys -f ${HOME}/.xbindkeysrc")
