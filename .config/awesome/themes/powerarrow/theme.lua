...
theme.taglist_font                              = "Noto Sans Regular 22"
...
function theme.at_screen_connect(s)
   ...
   s.quake = lain.util.quake({ app = "termite", height = 0.50, argname = "--name %s" })
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, height = 27, bg = theme.bg_normal, fg = theme.fg_normal })
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            arrow("alpha", "#889FA7"),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, 2, 3), "#889FA7"),
            arrow("#889FA7", "#497B96"),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, 3, 4), "#497B96"),
            arrow("#497B96", "#4B3B51"),
